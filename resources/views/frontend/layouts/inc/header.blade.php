                        ...
                        <ul>
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li><a href="#"><img src="{{ asset('admin/assets/front/imgs/theme/flag-fr.png')}}"
                                                alt="">Français</a></li>
                                    <li><a href="#"><img src="{{ asset('admin/assets/front/imgs/theme/flag-dt.png')}}"
                                                alt="">Deutsch</a></li>
                                    <li><a href="#"><img src="{{ asset('admin/assets/front/imgs/theme/flag-ru.png')}}"
                                                alt="">Pусский</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.html">
                                    <img class="svgInject" alt="Evara"
                                        src="{{ asset('admin/assets/front/imgs/theme/icons/icon-heart.svg')}}">
                                    <span class="pro-count blue">4</span>
                                </a>
                            </div>
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="shop-cart.html">
                                    <img alt="Evara" src="{{ asset('admin/assets/front/imgs/theme/icons/icon-cart.svg')}}">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Evara"
                                                        src="{{ asset('admin/assets/front/imgs/shop/thumbnail-3.jpg')}}"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Evara"
                                                        src="{{ asset('admin/assets/front/imgs/shop/thumbnail-2.jpg')}}"></a>
                                            </div>
                                            <div class="shopping-cart-title">
            ...
            <div class="header-wrap header-space-between position-relative">
                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{ asset('admin/assets/front/imgs/banner/menu-banner-2.jpg')}}"
                                                        alt="menu_banner1">
                                                ...
                                                <div class="header-banner2">
                                                    <img src="{{ asset('admin/assets/front/imgs/banner/menu-banner-3.jpg')}}"
                                                        alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{ asset('admin/assets/front/imgs/banner/menu-banner-4.jpg')}}"
                                                        alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{ asset('admin/assets/front/imgs/banner/menu-banner-5.jpg')}}"
                                                        alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                                ...
                                                <div class="header-banner2">
                                                    <img src="{{ asset('admin/assets/front/imgs/banner/menu-banner-6.jpg')}}"
                                                        alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="shop-product-right.html"><img
                                                        src="{{ asset('admin/assets/front/imgs/banner/menu-banner.jpg')}}"
                                                        alt="Evara"></a>
                ...
                <div class="header-action-right d-block d-lg-none">
                    <div class="header-action-2">
                        <div class="header-action-icon-2">
                            <a href="shop-wishlist.html">
                                <img alt="Evara" src="{{ asset('admin/assets/front/imgs/theme/icons/icon-heart.svg')}}">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Evara"
                                                    src="{{ asset('admin/assets/front/imgs/shop/thumbnail-4.jpg')}}"></a>
                                        </div>
                                        <div class="shopping-cart-title">
