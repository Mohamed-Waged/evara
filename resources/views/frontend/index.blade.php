        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="deal" style="background-image: url('admin/assets/front/imgs/banner/menu-banner-7.png')">
                        <div class="deal-top">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-gallery">
                                ...
                                <div class="slider-nav-thumbnails pl-15 pr-15">
                                    <div><img src="{{ asset('admin/assets/front/imgs/shop/thumbnail-3.jpg')}}" alt="product image"></div>
                                    <div><img src="{{ asset('admin/assets/front/imgs/shop/thumbnail-4.jpg')}}" alt="product image"></div>
                                    <div><img src="{{ asset('admin/assets/front/imgs/shop/thumbnail-5.jpg')}}" alt="product image"></div>
                                    <div><img src="{{ asset('admin/assets/front/imgs/shop/thumbnail-6.jpg')}}" alt="product image"></div>
                                    <div><img src="{{ asset('admin/assets/front/imgs/shop/thumbnail-7.jpg')}}" alt="product image"></div>
                                    <div><img src="{{ asset('admin/assets/front/imgs/shop/thumbnail-8.jpg')}}" alt="product image"></div>
                                    <div><img src="{{ asset('admin/assets/front/imgs/shop/thumbnail-9.jpg')}}" alt="product image"></div>
                                </div>
                            </div>
                            <!-- End Gallery -->
                            <div class="social-icons single-share">
                                <ul class="text-grey-5 d-inline-block">
                                    ...
                                    <li class="social-facebook"><a href="#"><img
                                                src="{{ asset('admin/assets/front/imgs/theme/icons/icon-facebook.svg')}}" alt=""></a>
                                    </li>
                                    <li class="social-twitter"> <a href="#"><img
                                                src="{{ asset('admin/assets/front/imgs/theme/icons/icon-twitter.svg')}}" alt=""></a>
                                    </li>
                                    <li class="social-instagram"><a href="#"><img
                                                src="{{ asset('admin/assets/front/imgs/theme/icons/icon-instagram.svg')}}" alt=""></a>
                                    </li>
                                    <li class="social-linkedin"><a href="#"><img
                                                src="{{ asset('admin/assets/front/imgs/theme/icons/icon-pinterest.svg')}}" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center slider-animated-1">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-1" src="{{ asset('admin/assets/front/imgs/slider/slider-1.png')}}"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slider single-animation-wrap">
                <div class="container">
                    <div class="row align-items-center slider-animated-1">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-2" src="{{ asset('admin/assets/front/imgs/slider/slider-2.png')}}"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-hero-slider single-animation-wrap">
                <div class="container">
                    <div class="row align-items-center slider-animated-1">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-3" src="{{ asset('admin/assets/front/imgs/slider/slider-3.png')}}"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up">
                        <img src="{{ asset('admin/assets/front/imgs/theme/icons/feature-1.png')}}" alt="">
                        <h4 class="bg-1">Free Shipping</h4>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up">
                        <img src="{{ asset('admin/assets/front/imgs/theme/icons/feature-2.png')}}" alt="">
                        <h4 class="bg-3">Online Order</h4>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up">
                        <img src="{{ asset('admin/assets/front/imgs/theme/icons/feature-3.png')}}" alt="">
                        <h4 class="bg-2">Save Money</h4>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up">
                        <img src="{{ asset('admin/assets/front/imgs/theme/icons/feature-4.png')}}" alt="">
                        <h4 class="bg-4">Promotions</h4>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up">
                        <img src="{{ asset('admin/assets/front/imgs/theme/icons/feature-5.png')}}" alt="">
                        <h4 class="bg-5">Happy Sell</h4>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                    <div class="banner-features wow fadeIn animated hover-up">
                        <img src="{{ asset('admin/assets/front/imgs/theme/icons/feature-6.png')}}" alt="">
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-1-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-1-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-2-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-2-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-3-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-3-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-4-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-4-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-5-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-5-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-6-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-6-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-7-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-7-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-8-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-8-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-9-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-9-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-10-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-10-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-11-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-11-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-12-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-12-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-13-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-13-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-14-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-14-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-15-1.jpg')}}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-15-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-3-1.jpg')}}"
                                                alt="">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-3-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-4-1.jpg')}}"
                                                alt="">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-4-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-5-1.jpg')}}"
                                                alt="">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-5-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-6-1.jpg')}}"
                                                alt="">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-6-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-7-1.jpg')}}"
                                                alt="">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-7-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-8-1.jpg')}}"
                                                alt="">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-8-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="hover-img" src="{{ asset('admin/assets/front/imgs/shop/product-9-1.jpg')}}"
                                                alt="">
                                            <img class="default-img" src="{{ asset('admin/assets/front/imgs/shop/product-9-2.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
    ...
    <section class="banner-2 section-padding pb-0">
        <div class="container">
            <div class="banner-img banner-big wow fadeIn animated f-none">
                <img src="{{ asset('admin/assets/front/imgs/banner/banner-4.png')}}" alt="">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('admin/assets/front/imgs/shop/category-thumb-1.jpg')}}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"> <img src="{{ asset('admin/assets/front/imgs/shop/category-thumb-2.jpg')}}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('admin/assets/front/imgs/shop/category-thumb-3.jpg')}}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('admin/assets/front/imgs/shop/category-thumb-4.jpg')}}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('admin/assets/front/imgs/shop/category-thumb-5.jpg')}}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('admin/assets/front/imgs/shop/category-thumb-6.jpg')}}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('admin/assets/front/imgs/shop/category-thumb-7.jpg')}}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('admin/assets/front/imgs/shop/category-thumb-8.jpg')}}"
                                    alt=""></a>
                        </figure>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow fadeIn animated">
                        <img src="{{ asset('admin/assets/front/imgs/banner/banner-1.png')}}" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow fadeIn animated">
                        <img src="{{ asset('admin/assets/front/imgs/banner/banner-2.png')}}" alt="">
                        <div class="banner-text">
                            <span>Sale off</span>
                ...
                <div class="col-lg-4 d-md-none d-lg-flex">
                    <div class="banner-img wow fadeIn animated  mb-sm-0">
                        <img src="{{ asset('admin/assets/front/imgs/banner/banner-3.png')}}" alt="">
                        <div class="banner-text">
            ...
            <div class="row">
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0"
                        style="background-image: url('admin/assets/front/imgs/banner/menu-banner-7.jpg')}}');">
                        <div class="deal-top">
                            <h2 class="text-brand">Deal of the Day</h2>
                            <h5>Limited quantities.</h5>
                        </div>
                ...
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated"
                        style="background-image: url('admin/assets/front/imgs/banner/menu-banner-8.jpg')}}');">
                        <div class="deal-top">
            ...
            <div class="row">
                <div class="col-lg-3 d-none d-lg-flex">
                    <div class="banner-img style-2 wow fadeIn animated">
                        <img src="{{ asset('admin/assets/front/imgs/banner/banner-9.jpg')}}" alt="">
                        <div class="banner-text">
                                            ...
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-1-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-1-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-2-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-2-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-3-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-3-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-4-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-4-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-11-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-11-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-6-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-6-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-7-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-7-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-5-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-5-1.jpg')}}" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-10-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-10-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-12-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-12-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-8-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-8-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-13-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-13-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-14-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-14-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="shop-product-right.html">
                                                    <img class="default-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-15-1.jpg')}}" alt="">
                                                    <img class="hover-img"
                                                        src="{{ asset('admin/assets/front/imgs/shop/product-15-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="banner-img banner-1 wow fadeIn animated">
                                <img src="{{ asset('admin/assets/front/imgs/banner/banner-5.jpg')}}" alt="">
                                <div class="banner-text">
                        ...
                        <div class="col-md-6">
                            <div class="banner-img mb-15 wow fadeIn animated">
                                <img src="{{ asset('admin/assets/front/imgs/banner/banner-6.jpg')}}" alt="">
                                <div class="banner-text">
                                    <span>Big Offer</span>
                            ...
                            <div class="banner-img banner-2 wow fadeIn animated">
                                <img src="{{ asset('admin/assets/front/imgs/banner/banner-7.jpg')}}" alt="">
                                <div class="banner-text">
                                    <span>Smart Offer</span>
