                ...
                <div class="product-detail accordion-detail">
                    <div class="row mb-50">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            {{-- <img class='rounded' style='height:400px' src="{{ Storage::url($product->images[0]) }}" alt="{{ $product->name }}"> --}}
                            <!-- MAIN SLIDES -->
                            <div class="product-image-slider">
                                @foreach ($product->images as $image)
                                    <figure class="border-radius-10">
                                        <img class='rounded' style='height:400px' src="{{ Storage::url($image) }}" alt="{{ $product->name }}">
                                    </figure>
                                @endforeach
                            </div>
                            <!-- THUMBNAILS -->
                            <div class="slider-nav-thumbnails pl-15 pr-15">
                                @foreach ($product->images as $image)
                                    <div>
                                        <img src="{{ Storage::url($image) }}" title="{{ $product->name }}" alt={{ $product->name }} class='rounded' >
                                    </div>
                                @endforeach
                            </div>
                        </div>
